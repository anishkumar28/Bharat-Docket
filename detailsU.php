      ...
      <div class="mainContent">
        ...
        <div class="overViewDiv">
           <div class="intro flex" >
             ...
             <div class="addBtn">
            <a target="_blank" href="pdfDetailsU.php?id= <?php echo $caseId;?>">
                 ...
                 <div class="detailsContainer" id="detailsContainer">
                      ...
                      <div class="row">
                        ...
                        <?php 
                          ...
                          if($img1!=""){   
                            ?>
                              <img src="OB Images/ObImage<?php echo $img1;?>">
                        ...
                        <?php 
                          ...
                          if($img2!=""){   
                            ?>
                              <img src="OB Images/ObImage<?php echo $img2;?>">
                        ...
                        <?php 
                          ...
                          if($img3!=""){   
                            ?>
                              <img src="OB Images/ObImage<?php echo $img3;?>">
