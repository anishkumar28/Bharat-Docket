                              ...
                              while($row = mysqli_fetch_assoc($res)){
                                ...
                                if($caseStatus=='Open'){
                                  ...
                                  <tr class="tableData">
                                    ...
                                    <td><a href="updateCase.php?id= <?php echo $id;?>"><i class="uil uil-edit icon editIcon"></i></a></td>
          
                                    <td><a href="details.php?id= <?php echo $id;?>"><i class="uil uil-file-info-alt icon detailsIcon"></i></a></td>
                                    
                                   <td><a href="following.php?id= <?php echo $id;?>"><i class="uil uil-arrow-from-right icon followIcon"></i></a></td>
                                  </tr>
