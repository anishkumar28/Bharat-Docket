                              ...
                              while($row = mysqli_fetch_assoc($result)){
                                   ...
                                   ?>
                                        ...
                                        <tr class="tableData"> 
                                          ...
                                          <td><a href="updateAdmin.php?id=<?php echo $dbID; ?>"><i class="uil uil-edit icon editIcon"></i></a></td>
                                          <td> <a href="deleteAdmin.php?id= <?php echo $dbID;?>"><i class="uil uil-times-square icon deleteIcon"></i></a></td>
                                        </tr>
