                    ...
                    if($sType != "" || $sStatus != "" || $sDate != "" || $OBNumber != ""){
                        ...
                        if($res  == TRUE){
                           ...
                           <tr class="tableData">
                               ...
                               <td><a href="updatefollowupU.php?id= <?php echo $id;?>"><i class="uil uil-edit icon editIcon"></i></a></td>
                            
                               <td><a href="followupdetailsU.php?id= <?php echo $id;?>"><i class="uil uil-file-info-alt icon detailsIcon"></i></a></td>
                        ...
                        header('location:' . 'searcFollowupU.php');
                        exit();
                    }
